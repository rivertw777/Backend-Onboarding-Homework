...
class UserDomainServiceTest {
    ...
    void createUser_Success() {
        ...
        // when
        User createdUser = userDomainService.createUser(username, encodedPassword, nickname);
    ...
    void createUser_WithDuplicateUsername_ThrowsException() {
        ...
        String encodedPassword = "encodedPassword";
        String nickname = "nickname";
        User existingUser = User.create(username, encodedPassword, nickname);
        ...
        // when & then
        assertThatThrownBy(() ->
                userDomainService.createUser(username, encodedPassword, nickname))
